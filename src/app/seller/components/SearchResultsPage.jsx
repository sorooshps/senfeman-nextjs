...
const SearchResultsPage = ({
  ...
  // Handle recent search click with router
  const handleRecentSearchClickWithRouter = (item) => {
      ...
      <div className="lg:hidden pb-20 px-4">
        ...
        <div className="relative mb-4">
          <SearchInput
            ...
            onSearch={handleSearchWithRouter} // UPDATED
            mobile={true}
          />
        </div>
      ...
      تماس سریع
            ...
            <div className="lg:col-span-2 space-y-6 mt-[216px]" dir="rtl">
              ...
              <RecentSearches
                ...
                onRecentSearchClick={handleRecentSearchClickWithRouter} // UPDATED
