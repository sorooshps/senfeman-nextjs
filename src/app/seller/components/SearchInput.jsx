        ...
        <div className="relative">
          ...
          {value && (
            <button
              type="button"
              onClick={handleClear}
              className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 p-1.5 rounded-lg hover:bg-gray-100 transition-all duration-200 z-10"
          ...
          <input
            ...
            className={`w-full bg-white border-2 border-gray-200 text-gray-700 focus:outline-none text-base rounded-2xl px-5 py-4 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg placeholder:text-gray-400 ${
              value ? 'pr-12 pl-12' : 'pr-12'
            }`}
            value={value}
            onChange={onChange}
            onFocus={onFocus}
