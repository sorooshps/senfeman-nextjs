        ...
        <div className="px-5 pt-6 pb-4">
          <div className="relative">
            ...
            <div className="relative flex items-center">
              ...
              {/* Clear button on left - only shows when there's text */}
              {searchQuery && (
                <button
                  type="button"
                  onClick={handleClearSearch}
                  className="absolute left-16 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 p-1.5 rounded-lg hover:bg-gray-100 transition-all duration-200 z-10"
              ...
              <input
                ...
                type="text"
                placeholder="جستجوی محصول، برند یا دسته‌بندی..."
                className={`w-full bg-gray-50 border-2 border-gray-100 rounded-2xl py-4 text-gray-700 text-base focus:outline-none focus:border-blue-500 focus:bg-white transition-all duration-200 placeholder:text-gray-400 ${
                  searchQuery ? 'pl-16 pr-12' : 'pl-14 pr-12'
                }`}
                value={searchQuery}
                onChange={onSearchInputChange}
                onKeyDown={handleKeyDown}
